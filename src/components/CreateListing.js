...
class CreateListing extends Component {
  ...
  onCreateListing = event => {
    ...
    if (user) {
      createListing(user, this.state)
        ...
        .catch(error => {
          this.setState({ name: '', location: '', dateAvail: '' })
          msgAlert({
  ...
  render () {
    const { name, city, stateProvince, postalCode, latitude, longitude, rate, description  } = this.state
          ...
          <Form onSubmit={this.onCreateListing}>
            ...
            <Form.Group controlId="rate">
              ...
              <Form.Control
                ...
                name="rate"
                value={rate}
                placeholder="Enter your asking rate."
                onChange={this.handleChange}
              />
            </Form.Group>
