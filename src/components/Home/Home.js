        ...
        <div className="container-section">
          ...
          <div className="slider-container">
            ...
            <div className="horizontal-scroller">
              ...
              <div className="box gems-box scroll-item" style={{ backgroundImage: 'url(https://images.pexels.com/photos/1297465/pexels-photo-1297465.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)' }}></div>
              <div className="box gems-box scroll-item" style={{ backgroundImage: 'url(https://images.pexels.com/photos/6127316/pexels-photo-6127316.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)' }}></div>
              <div className="box gems-box scroll-item" style={{ backgroundImage: 'url(https://images.pexels.com/photos/4473399/pexels-photo-4473399.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)' }}></div>
              <div className="box gems-box scroll-item" style={{ backgroundImage: 'url(https://images.pexels.com/photos/1537635/pexels-photo-1537635.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)' }}></div>
            </div>
          </div>
